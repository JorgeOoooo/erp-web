      ...
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          ...
          <a-button
            ...
            >批量删除</a-button
          >
          <a-button @click="refresh" type="default" icon="reload"
            >刷新</a-button
          >
        </a-row>
        <div
      ...
      <a-card :bordered="false" v-if="selectedKeys.length > 0">
        <a-form :form="form">
          ...
          >
            <a-input
              placeholder="请输入名称"
              v-decorator="['orgAbr', validatorRules.orgAbr]"
            />
          </a-form-item>
          <a-form-item
            :labelCol="labelCol"
          ...
          >
            <a-input
              placeholder="请输入编号"
              v-decorator="['orgNo', validatorRules.orgNo]"
            />
          </a-form-item>
          <a-form-item
            :labelCol="labelCol"
    ...
    setValuesToForm(record) {
      this.$nextTick(() => {
        this.form.setFieldsValue(
          pick(record, "orgAbr", "orgNo", "parentId", "sort", "remark")
        );
      });
    },
    getCurrSelectedTitle() {
