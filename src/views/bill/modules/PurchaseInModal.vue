      ...
      <a-form :form="form">
          ...
          <template #buttonAfter>
            ...
            >
              <a-col v-if="scanStatus" :md="6" :sm="24">
                <a-button @click="scanEnter" style="margin-right: 8px"
                  >扫码录入</a-button
                >
              </a-col>
              <a-col
              ...
              >
                <a-button @click="stopScan" style="margin-right: 8px"
                  >收起扫码</a-button
                >
              </a-col>
            </a-row>
            <a-row :gutter="24" style="float: left; padding-bottom: 5px">
              <a-col :md="24" :sm="24">
                <a-button @click="handleHistoryBillList"
        ...
        <a-row class="form-row" :gutter="24">
          ...
          <a-col v-if="depositStatus" :lg="6" :md="12" :sm="24">
            ...
            >
              <a-input
                v-decorator.trim="['deposit']"
                @change="onChangeDeposit"
              />
            </a-form-item>
          </a-col>
          <a-col :lg="6" :md="12" :sm="24">
