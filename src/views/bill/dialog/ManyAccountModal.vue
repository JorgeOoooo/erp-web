          ...
          <a-row class="form-row" :gutter="24">
            ...
            <a-col :lg="12" :md="12" :sm="24">
              ...
              >
                <a-input-number
                  placeholder="请输入金额"
                  v-decorator.trim="['oneAccountPrice']"
                />
              </a-form-item>
            </a-col>
          </a-row>
          <a-row class="form-row" :gutter="24">
            ...
            <a-col :lg="12" :md="12" :sm="24">
              ...
              >
                <a-input-number
                  placeholder="请输入金额"
                  v-decorator.trim="['twoAccountPrice']"
                />
              </a-form-item>
            </a-col>
          </a-row>
          <a-row class="form-row" :gutter="24">
            ...
            <a-col :lg="12" :md="12" :sm="24">
              ...
              >
                <a-input-number
                  placeholder="请输入金额"
                  v-decorator.trim="['threeAccountPrice']"
                />
              </a-form-item>
            </a-col>
          </a-row>
    ...
    handleOk() {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          if (
            that.accountIdList.length < 2 ||
            that.accountMoneyList.length < 2
          ) {
