        ...
        <div class="table-page-search-wrapper">
          ...
          <a-form layout="inline" @keyup.enter.native="onSearch">
            <a-row :gutter="24">
              ...
              >
                <a-col :md="6" :sm="24">
                  <a-button type="primary" @click="loadMaterialData(1)"
                    >查询</a-button
                  >
                  <a-button style="margin-left: 8px" @click="searchReset(1)"
                    >重置</a-button
                  >
                  <a-tooltip title="没查询到，决定新增商品！">
                    <a-button style="margin-left: 8px" @click="addMaterial"
                      >新增</a-button
                    >
                  </a-tooltip>
            ...
            <template slot="customBarCode" slot-scope="text, record">
              ...
              <a-popover placement="right" trigger="click">
                ...
                <img
                  ...
                  style="cursor: pointer; max-width: 40px; max-height: 30px"
                  title="查看大图"
                />
              </a-popover>
            </template>
