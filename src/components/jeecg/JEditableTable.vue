      ...
      <a-col>
        ...
        <div v-if="actionButton" class="action-button">
          ...
          <template v-if="selectedRowIds.length > 0">
            ...
            >
              <a-button type="primary" icon="minus" :disabled="disabled"
                >移除行</a-button
              >
              <span class="gap"></span>
            </a-popconfirm>
                      ...
                      >
                        ...
                        >
                          <j-input-pop
                            ...
                            @change="
                              (v) =>
                                handleChangeJInputPopCommon(v, id, row, col)
                            "
                          >
                          </j-input-pop>
                        </span>
                        ...
                        >
                          ...
                          >
                            <a-upload
                              ...
                              v-bind="buildProps(row, col)"
                              @change="
                                (v) => handleChangeUpload(v, id, row, col)
                              "
                            >
    ...
    _pushByDataSource(
      ...
      dataSource.forEach((data, newValueIndex) => {
        ...
        this.columns.forEach((column) => {
          ...
          let sourceValue = (
            data[column.key] == null ? "" : data[column.key]
          ).toString();
